...
import cableDesignSchema from './schemas/v1/cable-design.schema.json' with { type: 'json' };
import drcResultSchema from './schemas/v1/drc-result.schema.json' with { type: 'json' };
let _ajv = null;
